  ...
  return (
          <div className="flex flex-col gap-4">
            ...
            <SubSystem
              ...
              synthesis={`${chineseZodiac.animal} is the base temperament, and ${chineseZodiac.element} is what colors how that temperament actually gets expressed, ${(CHINESE_ELEMENT_MEANING[chineseZodiac.element] || "in its own way").toLowerCase()}. Same animal born in a different element year would move through the world noticeably differently.`}
              rows={[]}
              customRows={[
